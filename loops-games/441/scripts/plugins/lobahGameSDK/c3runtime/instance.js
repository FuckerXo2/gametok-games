...
C3.Plugins.lobahGameSDK.Instance = class SingleGlobalInstance extends globalThis.ISDKInstanceBase
{
	constructor()
	{
		...
		globalThis.addEventListener("message", function(e) {
			if (e && e.data && e.data.type && (e.data.type === "lobah-main-location-response" || e.data.type === "lobah-location-changed")) {
				const msg = e.data;
				try {
					console.log("lobah-main-location-response:", msg.search);
					C3.Plugins.lobahGameSDK.search = msg.search;
					console.log("C3.Plugins.lobahGameSDK.search:", C3.Plugins.lobahGameSDK.search);
				} catch (e) {
		...
		globalThis.postMessage({
			type: "lobah-request-main-location"
		});
