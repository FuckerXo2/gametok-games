window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {},
    function(t, e) {
        ...
        class s extends e.Script {
            ...
            static initCFG(t) {
                this.platformCfg = t, this.adViewUrl = {
                    screenAd: "views/ad/FullAd_4.scene",
                    floatAd: "views/ad/FloatAd.scene",
                    listAd: "views/ad/FullAd.scene",
                    knockEggAd: "views/ad/KnockEgg.scene"
                }, this.adViewScript = {
                    screenAd: E,
                    floatAd: A,
                    listAd: S,
            ...
            static enterGamePopup(t) {
                a.zs_jump_switch && a.isPublicVersion() && a.zs_auto_full_screen_jump_switch ? (s.showScreenAd(),
                    e.stage.on(s.UI_VIEW_CLOSED, s, s.checkEnter, [t])) : t.run();
            }
            static checkEnter(t, i) {
                "FullAd_4" == i && (a.zs_Fakerjump ? (s.showListAd(), e.stage.on(s.UI_VIEW_CLOSED, s, s.enterOver, [t])) : t.run(),
                    e.stage.off(s.UI_VIEW_CLOSED, s, s.checkEnter));
            }
            static enterOver(t, i) {
                "FullAd" == i && (t.run(), e.stage.on(s.UI_VIEW_CLOSED, s, s.enterOver));
            }
            ...
            static onHideExportView(t, i, n) {
                if ("FullAd" == n) 0 == t ? e.stage.event(s.OPEN_FAILED_VIEW, [i]) : 1 == t && e.stage.event(s.OPEN_WIN_VIEW, [i]),
                    e.stage.off(s.UI_VIEW_CLOSED, null, s.onHideExportView);
                else if ("FullAd_4" == n && 2 == t && i.viewName == n) {
        ...
        class a {
            ...
            static initAdSetting(t, s) {
                ...
                this.zs_switch = 1 == s.zs_switch && r && this.isPublicVersion(), this.egg_switch = 1 == s.zs_switch && this.isPublicVersion(),
                    ...
                    this.zs_show_share_num = s.zs_show_share_num ? s.zs_show_share_num : 0, this.zs_start_video_switch = 1 == this.getNumberVal(s.zs_start_video_switch, 0),
                    this.zs_start_game_video_switch = 1 == s.zs_start_game_video_switch, this.zs_auto_pop_ups_switch = 1 == this.getNumberVal(s.zs_auto_pop_ups_switch, 0),
                    ...
                    this.zs_Fakerjump = 1 == s.zs_Fakerjump, this.zs_skin_push_switch = s.zs_skin_push_switch ? Number(s.zs_skin_push_switch) : 0,
            ...
            static initOpenAwardNum() {
                this.open_award_num = e.LocalStorage.getItem("open_award_num") || 0;
                var t = e.LocalStorage.getItem("open_award_num_time_stamp");
                null != t && "" != t && 0 != i.isToday(Number(t)) || (e.LocalStorage.setItem("open_award_num_time_stamp", Date.now().toString()),
                    e.LocalStorage.setItem("open_award_num", 0), e.LocalStorage.setItem("open_ready_num", 0),
                    e.LocalStorage.setItem("open_recorder_num", 0), e.LocalStorage.setItem("CheckDatas", JSON.stringify({})));
            }
            static updateGameNum() {
                this.gameNum = e.LocalStorage.getItem("day_game_num") || 0, this.gameNum += 1, e.LocalStorage.setItem("day_game_num", this.gameNum);
                var t = e.LocalStorage.getItem("game_num_time_stamp");
                null != t && "" != t && 0 != i.isToday(Number(t)) || (e.LocalStorage.setItem("game_num_time_stamp", Date.now().toString()),
                    e.LocalStorage.setItem("day_game_num", this.gameNum = 0));
            }
            ...
            static isOpenEgg(t, s) {
                ...
                //     let t = e.LocalStorage.getItem("day_game_num");
                ...
                // if (i.IsNumber(n)) {
                //     let t = 1 == s ? e.LocalStorage.getItem("open_ready_num") : e.LocalStorage.getItem("open_award_num");
            ...
            static updateReviveTypeInfo(t) {
                ...
                var s = e.LocalStorage.getItem(t),
        ...
        a.response = null, a.zs_share_title = "", a.zs_share_image = "", a.zs_switch = !1,
            ...
            a.zs_finish_switch = !1, a.zs_false_news_switch = !1, a.zs_skin_push_switch = 0,
            a.zs_start_video_switch = !1, a.zs_Fakerjump = !1, e.ILaya.regClass(a), e.ClassUtils.regClass("zs.laya.platform.ADConfig", a),
        ...
        class n extends e.Script {
            ...
            checkChange(t) {
                var s = this.adData[t].app_title,
                    i = e.LocalStorage.getItem("CheckDatas");
                try {
                    (i = JSON.parse(i)) || (i = {});
                } catch (t) {
                    i = {};
            ...
            freshAdList() {
                ...
                if (this.adData = this.adData.filter(function(s) {
                    ...
                    }), this.checkData(), null != this.maxNum)
            ...
            onItemRender(t, e) {
                ...
                if (s) {
                    ...
                    if (1 != this.isDataUpdate) {
                        ...
                        if (d) this.hotIds.indexOf(e) > 0 ? (d.visible = !0, d.index = Math.floor(d.clipY * Math.random())) : d.visible = !1;
                        else {
                            var c = t.getChildByName("hot"),
                                u = t.getChildByName("new");
            ...
            onUpdate() {
                if (this.autoScroll && 1 == this.inAutoScroll && this.list && this.list.scrollBar && this.list.scrollBar.max) {
                    if (this.list.scrollBar.value >= this.list.scrollBar.max ? (this.list.scrollBar.value = this.list.scrollBar.max,
                            ...
                            this.scrollSpeed = 0 - this.scrollSpeed, this.isEnd = !0), this.list.scrollBar.value += this.scrollSpeed, !this.unitValue || !this.isClockPendulum) return;
        ...
        class c extends e.Script {
            ...
            checkChange(t) {
                var s = this.adDataArr[t].app_title,
                    i = e.LocalStorage.getItem("CheckDatas");
                try {
                    (i = JSON.parse(i)) || (i = {});
                } catch (t) {
        ...
        class C extends e.Script {
            ...
            onBoxClick(t) {
                if (this.isClick && (zs.laya.sdk.ZSReportSdk.navigate2Mini(this.adData[t], s.user_id, function() {
                        ...
                        e.stage.event(n.EVENT_NAVIGATE_FAILED), zs.laya.platform.ADConfig.zs_switch && zs.laya.platform.ADConfig.zs_reminder_switch && e.Scene.open("views/ad/ChallengePage.scene", !1);
                    ...
                    var a = this.owner.getChildByName("ad_" + t),
                        r = this.adData[t];
                    if (!r) return;
                    if (a) {
        ...
        class A extends zs.laya.base.ZhiSeView {
            ...
            onStart() {
                var t = this.owner.url.substring(this.owner.url.lastIndexOf("/") + 1, this.owner.url.lastIndexOf(".")),
                    e = s.platformCfg.exportGameCfg[t],
                    i = s.platformCfg;
        ...
        class v extends zs.laya.base.ZhiSeView {
            ...
            showFingerEff() {
                if (this.aniFinger) {
                    ...
                    var t = Math.random() * e.stage.width / 2 + e.stage.width / 4,
                        s = Math.random() * e.stage.height / 2 + e.stage.height / 4;
        ...
        class E extends zs.laya.base.ZhiSeView {
            ...
            checkChange(t, s) {
                var i = s.array[t],
                    a = i.app_title,
                    n = e.LocalStorage.getItem("CheckDatas");
                try {
                    (n = JSON.parse(n)) || (n = {});
                } catch (t) {
                    n = {};
            ...
            freshAdList() {
                ...
                if (this.adData.length > 3)
                    for (s = 3; s < this.adData.length; s++) i.push(this.adData[s]);
            ...
            initRankData() {
                ...
                for (e = 0; e < this.adData.length; e++) this.adData[e].rank = e + 1, this.adData[e].rank = 1 == this.adData[e].rank ? 2 : 2 == this.adData[e].rank ? 1 : this.adData[e].rank,
                    t = s * (.6 + .4 * Math.random()), s = t += (s - t) * Math.random() * .3, t = t > 10 ? 10 * Math.floor(t / 10) + "W" : t > 1 ? Math.floor(t) + "W" : 1e3 * Math.floor(10 * t),
            ...
            onStart() {
                ...
                let i = this;
                this.initData(), e.timer.once(500, this, function() {
                    if (this.mainAdList && this.mainAdList.array && this.mainAdList.array.length && a.zs_switch && a.zs_auto_jump_switch) {
            ...
            onItemRender(t, e, s) {
                if (t) {
                    var i = t.array[s];
                    if (i) {
                        if (a = e.getChildByName("icon")) a.skin = i.app_icon;
                        else {
            ...
            onUpdate() {
                if (1 == this.inAutoScroll && this.mainAdList && this.mainAdList.scrollBar && this.mainAdList.scrollBar.max) {
                    if (this.mainAdList.scrollBar.value >= this.mainAdList.scrollBar.max ? (this.mainAdList.scrollBar.value = this.mainAdList.scrollBar.max,
                            ...
                            this.scrollSpeed = 0 - this.scrollSpeed, this.isEnd = !0), this.mainAdList.scrollBar.value += this.scrollSpeed, !this.unitValue) return;
                    this.isEnd = this.isEnd && 0 != this.changeValue, this.changeValue += Math.abs(this.scrollSpeed),
                        (this.changeValue >= this.unitValue || this.isEnd) && (this.autoScroll = !1, this.isEnd = !1,
                            this.changeValue = 0, e.timer.once(this.waitTime, this, function() {
                                this.autoScroll = !0;
            ...
            onContinue() {
                if (!a.zs_switch || this.firstClick) this.closeView();
        ...
        class I extends zs.laya.base.ZhiSeView {
            ...
            clickHammer() {
                if (this.repairProgress + this.click_add_percent <= 1) {
                    if (this.updateRepairPorgress(this.repairProgress + this.click_add_percent), this.hammerAni && this.hammerAni.play(0, !1),
                        ...
                        this.bannerGroup && this.bannerGroup.show(), e.timer.once(800, this, this.resetIsOpenAd),
                            e.timer.once(800, this, function() {
            ...
            onFinish() {
                this.isGetAward || (this.isGetAward = !0, e.timer.once(this.awardDelay, this, function() {
        ...
        e.ILaya.regClass(D), e.ClassUtils.regClass("zs.laya.platform.NativeGridAdView", D),
            e.ClassUtils.regClass("Zhise.NativeGridAdView", D);
        class k extends e.Script {
            ...
            onAwake() {
                if (1 == a.isPublicVersion()) {
                    var t = this.owner.url.substring(this.owner.url.lastIndexOf("/") + 1, this.owner.url.lastIndexOf(".")),
                        e = s.platformCfg.mistakenlyTouchCfg[t];
                    if (e)
                        for (var i = 0; i < e.length; i++) {
                            const t = e[i],
                                s = this.findChildByPath(t.path);
                            var n = s.x,
                                r = s.y;
                            if (a.zs_switch) {
        ...
        e.ILaya.regClass(k), e.ClassUtils.regClass("zs.laya.platform.MistakenlyTouchCtrl", k),
            e.ClassUtils.regClass("Zhise.MistakenlyTouchCtrl", k);
        class N extends e.Script {
            onEnable() {
                this.viewName = this.owner.url, this.viewName = this.viewName.substring(this.viewName.lastIndexOf("/") + 1, this.viewName.lastIndexOf("."));
                var t = s.platformCfg.bannerCfg;
                e.stage.on(s.UI_VIEW_OPENED, this, this.hideBanner);
                var i = zs.laya.banner.WxBannerMgr.Instance;
                if (t) {
                    var n = t[this.viewName];
                    if (n) {
                        var r = n.initGroupArr;
                        if (r) {
                            console.log("setAdUnitId:", a.zs_banner_rotate_id1, a.zs_banner_rotate_id2, a.zs_banner_rotate_id3),
                                i.setAdUnitId(a.zs_banner_rotate_id1, a.zs_banner_rotate_id2, a.zs_banner_rotate_id3);
                            for (var h = i.adUnitIdData.length, o = 0; o < r.length; o++) {
                                const t = r[o];
                                i.initBannerGroupBySign(h <= 1 ? 0 : t.sign, t.length, t.autoChange, t.isReset);
                            }
                        }
                        h = i.adUnitIdData.length;
                        console.log("==================", this.viewName, "bannercfg:", h, "=================", n);
                        var l = n.showData;
                        if (l)
                            if (i.hideAllShow(), (!l.checkKey || l.checkKey && a[l.checkKey]) && !l.unAutoShow && (l.sign || 0 == l.sign || 0 == l.sign)) {
                                var d = i.getBannerGroup(h <= 1 ? 0 : l.sign);
                                l.isDelay && a.zs_banner_banner_time ? e.timer.once(a.zs_banner_banner_time, this, this.showBanner, [d]) : this.showBanner(d);
                            }
                        var c = n.exposureData;
                        if (c && h > 1) {
                            if (1 == n.pageType) {
                                if (!a.zs_full_screen_rotate) return;
                                i.lockHideExposure();
                            }
                            if (c.sign || 0 == c.sign || 0 == c.sign) {
                                d = i.getBannerGroup(c.sign);
                                var u = c.anchorArr;
                                if (u)
                                    for (o = 0; o < u.length; o++) {
                                        const t = u[o];
                                        d && d.showExposure(zs.laya.banner.WxBanner[t]);
                                    }
                            }
                        }
                        n.lockHide && i.lockHide();
                    }
                }
            }
            showBanner(t) {
                t && t.updateBottonTouch(), t && t.show();
            }
            hideBanner() {
                e.timer.clear(this, this.showBanner);
            }
            onDisable() {
                this.viewName = this.owner.url, this.viewName = this.viewName.substring(this.viewName.lastIndexOf("/") + 1, this.viewName.lastIndexOf("."));
                var t = s.platformCfg.bannerCfg,
                    i = zs.laya.banner.WxBannerMgr.Instance;
                if (t) {
                    var a = t[this.viewName],
                        n = i.adUnitIdData.length;
                    if (a) {
                        var r = a.showData;
                        if (r)
                            if (r.sign || 0 == r.sign || 0 == r.sign) e.timer.clear(this, this.showBanner),
                                (o = i.getBannerGroup(n <= 1 ? 0 : r.sign)) && o.hide();
                        var h = a.exposureData;
                        if (h && n > 1) {
                            var o;
                            if (1 == a.pageType) {
                            ...
                            if (h.sign || 0 == h.sign || 0 == h.sign)(o = i.getBannerGroup(h.sign)) && o.hideExposure();
                        }
        ...
        e.ILaya.regClass(N), e.ClassUtils.regClass("zs.laya.platform.BannerCtrl", N), e.ClassUtils.regClass("Zhise.BannerCtrl", N),
            ...
            t.MistakenlyTouchCtrl = k, t.BannerCtrl = N, t.AdList = n, t.FullScreeAdView_Rank = E,
            t.KnockEggView = I;
