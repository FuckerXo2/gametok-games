    ...
    function(t, e) {
        ...
        class s extends e.Script {
            ...
            applyLayout() {
                ...
                // this.middleUI && (this.middleUI.centerY = 0, this.middleUI.centerX = 0), 
        ...
        class i extends a {
            ...
            onEnable() {
                ...
                if (t) {
                    var e = t.bannerCfg;
                    e && e[this.viewName] && (this.owner.getComponent(zs.laya.platform.BannerCtrl) || this.owner.addComponent(zs.laya.platform.BannerCtrl));
