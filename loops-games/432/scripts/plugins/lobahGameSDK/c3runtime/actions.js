...
function urlParse() {
  ...
  let url = location.search || hash.slice(hash.indexOf("?"));
  if(C3 && C3.Plugins && C3.Plugins.lobahGameSDK && C3.Plugins.lobahGameSDK.search) {
    url = C3.Plugins.lobahGameSDK.search;
  }
